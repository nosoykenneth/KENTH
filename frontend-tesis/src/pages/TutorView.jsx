...
import { getChatSessions, createChatSession, deleteChatSession } from '../services/aiService';
...
export default function TutorView() {
  ...
  // Obtener el ID del usuario de Moodle
  ...
  const loadSessions = async () => {
    try {
      ...
      setSessions(data);
      // Si no hay sesión activa pero hay historial, seleccionamos la primera
            ...
            {!userId ? (
              ...
              <div className="absolute inset-0 p-4 sm:p-6 overflow-y-auto">
                <OllamaChat 
                  ...
                  contextoLeccion={JSON.stringify({ 
                    tipo: "navegacion_libre", 
                    mensaje: "El usuario está en el chat principal del tutor." 
                  })} 
                />
              </div>
            )}
