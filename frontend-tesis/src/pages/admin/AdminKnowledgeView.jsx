          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-kenth-card p-6 rounded-[2rem] border border-kenth-border shadow-[0_20px_50px_rgba(0,0,0,0.1)] flex flex-col items-center text-center">
              ...
              <button 
                ...
                className="w-full bg-kenth-surface/10 hover:bg-blue-600 text-kenth-text hover:text-white font-bold py-3 px-4 rounded-xl border border-blue-500/30 transition-all shadow-inner disabled:opacity-50 flex justify-center items-center gap-2"
              >
                {isUploading ? (
