...
export default function AcademyLayout() {
  ...
  // Entradas de administración de SITIO gateadas por capability real (siteadmin),
  // no por localStorage.moodle_rol (heurística por username, spoofeable). La
  // barrera real de estas vistas vive además en el backend (require_rag_admin).
  const { esTecnicoRAG } = useSitePermissions().perms;
